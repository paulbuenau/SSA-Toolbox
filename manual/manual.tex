...
$L_A(\mathcal{X})$ is the likelihood of the data set under the more complex alternative model. Under the 
null hypothesis $H_0$, this test statistic is approximately $\chi^2$ distributed with 
