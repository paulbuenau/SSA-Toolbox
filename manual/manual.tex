...
The SSA Toolbox consists of the classes \texttt{SSA}, \texttt{SSAParameters}, etc. 
...
The class \texttt{SSAParameters} stores the paramteres .. it is responsible for checking ...
...
The Toolbox needs jamtio (for Matlab files)

The algorithm uses jblas/this other CERN library
